...
const ActivityLog = ({ onBack }) => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans pb-12">
            ...
            {/* Header - UPDATED TO MATCH OTHER PAGES (max-w-6xl) */}
            <div className="bg-white border-b border-slate-200 px-6 py-4 sticky top-0 z-30 shadow-sm">
                <div className="max-w-6xl mx-auto flex items-center gap-3">
                    <div 
                        onClick={onBack} 
                        className="p-2 -ml-2 rounded-full hover:bg-slate-100 cursor-pointer text-slate-600 transition-colors"
            ...
            {/* Content - Kept centered and readable (max-w-3xl) */}
            <div className="max-w-3xl mx-auto p-6 space-y-6">
                
                {/* Intro Text (Moved here from header to keep header clean) */}
                <div className="mb-2">
                     <p className="text-slate-500 text-sm">Full timeline of your insurance purchases and claims.</p>
                </div>
